...
@section('main')
   <div class="row" style="height: 100vh">
    ...
    <div class="col-3 col-xl-2 border-1 shadow-sm">
        ...
        <li class=" my-2 font-semibold hover:text-slate-950 hover:scale-100 duration-300"><a href="{{route('admin#list')}}">User List</a></li>
        <li class=" my-2 font-semibold hover:text-slate-950 hover:scale-100 duration-300"><a href="{{route('cart#home')}}">Category</a></li>
        <li class=" my-2 font-semibold hover:text-slate-950 hover:scale-100 duration-300"><a href="">Order</a></li>
        <li class=" my-2 font-semibold hover:text-slate-950 hover:scale-100 duration-300"><a href="">Delivery</a></li>
       </ul>
        </div>
    </div>
